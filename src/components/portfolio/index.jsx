            ...
            <div className="text-center">
                ...
                <div className="grid grid-cols-3 gap-5 m-8">
                    <div className="shadow-lg rounded">
                        <img src="https://res.cloudinary.com/dhrzyzezw/image/upload/f_auto,q_auto/v1/portfolio/drdcbpedjakeiuhvkx6u" alt="photosignatureresize" className="w-full h-80 object-cover"/>
                    </div>
                    <div className="shadow-lg rounded">
                        <img src="https://res.cloudinary.com/dhrzyzezw/image/upload/f_auto,q_auto/v1/portfolio/drdcbpedjakeiuhvkx6u" alt="photosignatureresize" className="w-full h-80 object-cover"/>
                    </div>
